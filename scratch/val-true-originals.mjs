...
// for-reupload = originals with yellow tag fixes applied
const DIR = "C:/DCFG/Templates/for-reupload/";

const tests = [
  { name: "01-BWO", file: DIR + "Blanket-Work-Order.docx", contract: { ...bd } },
  { name: "02-ExhA-Auto", file: DIR + "Exhibit-A---Automated.docx", contract: { ...bd } },
  { name: "03-ExhA-Var", file: DIR + "Exhibit-A---Variable.docx", contract: { ...bd } },
  { name: "04-WO-Amend", file: DIR + "Work-Order-Amendment.docx", contract: { ...bd, dcfg_contract_type: 100000001, dcfg_contract_number: "AMD-24168-01" } },
  { name: "05-Decades-WO", file: DIR + "Decades-Workorder.docx", contract: { ...bd, dcfg_contract_family: 100000001, dcfg_contract_number: "DWO-2026-001" } },
  { name: "06-Bancroft-VA", file: DIR + "Bancroft-Vendor-Agreement.docx", contract: { ...bd, dcfg_contract_type: 100000002, dcfg_contract_number: "VA-2026-001" } },
  { name: "07-Decades-VA", file: DIR + "Decades-Vendor-Agreement.docx", contract: { ...bd, dcfg_contract_type: 100000002, dcfg_contract_family: 100000001, dcfg_contract_number: "VA-D-2026-001" } },
];
