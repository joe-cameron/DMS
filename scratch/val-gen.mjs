...
const bd = {
  ...
  dcfg_contract_date: "2026-05-17", dcfg_start_date: "2026-06-01", dcfg_end_date: "2027-05-31",
...
const af = [
  ...
  // --- Missing mappings found by visual validation ---
  // Decades WO + Decades VA + Bancroft VA: signature fields
  ...
  // Decades VA: DocuSign anchors as yellow text
  ...
  // Bancroft VA: DocuSign date anchors
  ...
  // Bancroft VA: Today straight quote variant
  { dcfg_source_text: "Today's Date", dcfg_dataverse_path: "[SYSTEM:TODAY]" },
  // Decades WO: underscore-padded signature text
  { dcfg_source_text: "_ Decades Title __", dcfg_dataverse_path: "dcfg_owner_title" },
];

const tests = [
  { name: "01-BWO", file: "Templates/corrected/Blanket-Work-Order.docx", contract: { ...bd } },
  { name: "02-ExhA-Auto", file: "Templates/corrected/Exhibit-A---Automated.docx", contract: { ...bd } },
  { name: "03-ExhA-Var", file: "Templates/corrected/Exhibit-A---Variable.docx", contract: { ...bd } },
  { name: "04-WO-Amend", file: "Templates/corrected/Work-Order-Amendment.docx", contract: { ...bd, dcfg_contract_type: 100000001, dcfg_contract_number: "AMD-24168-01" } },
  { name: "05-Decades-WO", file: "Templates/corrected/Decades-Workorder.docx", contract: { ...bd, dcfg_contract_family: 100000001, dcfg_contract_number: "DWO-2026-001" } },
  { name: "06-Bancroft-VA", file: "Templates/corrected/Bancroft-Vendor-Agreement.docx", contract: { ...bd, dcfg_contract_type: 100000002, dcfg_contract_number: "VA-2026-001" } },
  { name: "07-Decades-VA", file: "Templates/corrected/Decades-Vendor-Agreement.docx", contract: { ...bd, dcfg_contract_type: 100000002, dcfg_contract_family: 100000001, dcfg_contract_number: "VA-D-2026-001" } },
];
...
for (const t of tests) {
  ...
  writeFileSync("C:/DCFG/scratch/val-" + t.name + ".docx", buf);
